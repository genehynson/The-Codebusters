...
public class Reports extends Activity implements OnClickListener {
	...
	private Button menu;
	private List<AccountTransaction> importedTransactions = new ArrayList<AccountTransaction>();
	private List<AccountTransaction> sortedTransactions = new ArrayList<AccountTransaction>();
	...
	private class MyListAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (itemView == null) {
				itemView = getLayoutInflater().inflate(R.layout.reports_view,
						parent, false);
			}
