...
public class AccountTransaction {
     ...
     */
    public AccountTransaction(double amount, String currencyType,
            String type, String category, Date creationDate,
            String dateOfTransaction, String time) {
        this.type = type;
        this.amount = amount;
    ...
    public String toString() {
        return type + " of  " + amount + " in " + currencyType
                + " for/from " + category + " on " + dateOfTransaction
                + " at " + time;
    }
