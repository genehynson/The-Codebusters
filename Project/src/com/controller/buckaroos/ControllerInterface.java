...
public interface ControllerInterface {
     ...
     */
    Account getUserAccount(String accountName);
     ...
     */
    void addAccount(String accountName, String accountNickName,
     ...
     */
    void addWithdrawal(double amount, String currencyType,
     ...
     * @param dateChosen The date when the transaction takes place.
     */
    void addDeposit(double amount, String currencyType, String category,
            Date dateChosen);
     ...
     */
    void addLoginAccount(String name, String password, String email);

    /**
     * Gets user's login account.
     *
     * @param username The user's user name.
     * @return The user's login account.
     */
    User getLoginAccount(String username);
     ...
     */
    boolean doesLoginAccountExist(String accountName);
     ...
     */
    Map<String, Double> generateSpendingCategoryReport();
     ...
     */
    Map<String, Double> generateIncomeSourceReport();
     ...
     */
    Map<String, Double> generateCashFlowReport();
     ...
     */
    Map<String, Double> generateAccountListingReport();
